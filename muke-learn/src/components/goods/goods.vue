    ...
    methods: {
        ...
        _showFood() {
            this.foodComp = this.foodComp || this.$createFood({
                ...
                $events: {
                    add: (target) => {
                        this._shopCartStickyComp.drop(target)
                    },
                    leave:() => {
        ...
        _showShopCartSticky() {
            this._shopCartStickyComp = this._shopCartStickyComp || this.$ccreateShopCartSticky({
                $props:{
            ...
            this._shopCartStickyComp.show()
        },
        _hideShopCartSticky() {
            this._shopCartStickyComp.hide()
        }
    },
    components: {
        bubble,
